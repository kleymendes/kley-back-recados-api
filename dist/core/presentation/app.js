...
const user_routes_1 = __importDefault(require("../../features/users/presentation/routes/user.routes"));
const scrap_routes_1 = __importDefault(require("../../features/scraps/presentation/routes/scrap.routes"));
class App {
    constructor() {
    ...
    routes() {
        ...
        __classPrivateFieldGet(this, _App_express, "f").get('/', (_, response) => response.redirect('/api/v2'));
        __classPrivateFieldGet(this, _App_express, "f").use('/api/v2', router);
